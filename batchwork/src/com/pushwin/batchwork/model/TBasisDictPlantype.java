...
public class TBasisDictPlantype implements java.io.Serializable {
	...
	@Column(name = "CHILD_PRODUCT", length = 30)
	...
	public String toString() {
		return "TBasisDictPlantype [id=" + id + ", businid=" + businid
				+ ", businname=" + businname + ", low=" + low + ", floorlow="
				+ floorlow + ", cusclas=" + cusclas + ", panpro=" + panpro
