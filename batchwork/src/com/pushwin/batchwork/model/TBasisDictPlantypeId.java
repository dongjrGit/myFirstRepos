...
/**
 * TBasisDictPlantypeId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class TBasisDictPlantypeId implements java.io.Serializable {
	...
	/** default constructor */
	public TBasisDictPlantypeId() {
	}

	/** full constructor */
	public TBasisDictPlantypeId(String busintypeid, String businidbranch,
			String oraarea) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TBasisDictPlantypeId))
			return false;
		TBasisDictPlantypeId castOther = (TBasisDictPlantypeId) other;
