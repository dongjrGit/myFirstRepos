...
/**
 * TBasisDictPlanstoregood entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "T_BASIS_DICT_PLANSTOREGOOD")
public class TBasisDictPlanstoregood implements java.io.Serializable {

	// Fields

	private TBasisDictPlanstoregoodId id;
	private String area;
	...
	/** default constructor */
	public TBasisDictPlanstoregood() {
	}

	/** minimal constructor */
	public TBasisDictPlanstoregood(TBasisDictPlanstoregoodId id) {
		this.id = id;
	}

	/** full constructor */
	public TBasisDictPlanstoregood(TBasisDictPlanstoregoodId id, String area,
	...
	public TBasisDictPlanstoregoodId getId() {
		return this.id;
	}

	public void setId(TBasisDictPlanstoregoodId id) {
		this.id = id;
	}
