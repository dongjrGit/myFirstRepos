...
/**
 * TBasisBusCompabymemoId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class TBasisBusCompabymemoId implements java.io.Serializable {
	...
	/** default constructor */
	public TBasisBusCompabymemoId() {
	}

	/** full constructor */
	public TBasisBusCompabymemoId(String businid, String businidBracnch) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TBasisBusCompabymemoId))
			return false;
		TBasisBusCompabymemoId castOther = (TBasisBusCompabymemoId) other;
