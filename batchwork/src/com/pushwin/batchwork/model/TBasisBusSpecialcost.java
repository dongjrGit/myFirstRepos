...
/**
 * TBasisBusSpecialcost entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "T_BASIS_BUS_SPECIALCOST")
public class TBasisBusSpecialcost implements java.io.Serializable {

	// Fields

	private TBasisBusSpecialcostId id;
	...
	/** default constructor */
	public TBasisBusSpecialcost() {
	}

	/** minimal constructor */
	public TBasisBusSpecialcost(TBasisBusSpecialcostId id, String busintypeid,
			String area) {
		this.id = id;
	...
	/** full constructor */
	public TBasisBusSpecialcost(TBasisBusSpecialcostId id, String businname,
	...
	public TBasisBusSpecialcostId getId() {
		return this.id;
	}

	public void setId(TBasisBusSpecialcostId id) {
		this.id = id;
	}
