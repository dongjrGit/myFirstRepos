...
/**
 * TBasisBusIgroup entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "T_BASIS_BUS_IGROUP")
public class TBasisBusIgroup implements java.io.Serializable {

	// Fields

	private TBasisBusIgroupId id;
	...
	/** default constructor */
	public TBasisBusIgroup() {
	}

	/** minimal constructor */
	public TBasisBusIgroup(TBasisBusIgroupId id) {
		this.id = id;
	}

	/** full constructor */
	public TBasisBusIgroup(TBasisBusIgroupId id, String groupName,
	...
	public TBasisBusIgroupId getId() {
		return this.id;
	}

	public void setId(TBasisBusIgroupId id) {
		this.id = id;
	}
