...
/**
 * TBasisBusStoregoogs entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "T_BASIS_BUS_STOREGOOGS")
public class TBasisBusStoregoogs implements java.io.Serializable {
	...
	/** default constructor */
	public TBasisBusStoregoogs() {
	}

	/** minimal constructor */
	public TBasisBusStoregoogs(String businid) {
		this.businid = businid;
	}

	/** full constructor */
	public TBasisBusStoregoogs(String businid, String storeid,
