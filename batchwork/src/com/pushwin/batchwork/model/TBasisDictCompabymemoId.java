...
/**
 * TBasisDictCompabymemoId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class TBasisDictCompabymemoId implements java.io.Serializable {
	...
	/** default constructor */
	public TBasisDictCompabymemoId() {
	}

	/** full constructor */
	public TBasisDictCompabymemoId(String businid, String businidBracnch) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TBasisDictCompabymemoId))
			return false;
		TBasisDictCompabymemoId castOther = (TBasisDictCompabymemoId) other;
