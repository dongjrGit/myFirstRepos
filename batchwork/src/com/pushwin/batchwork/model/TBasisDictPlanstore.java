...
/**
 * TBasisDictPlanstore entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "T_BASIS_DICT_PLANSTORE")
public class TBasisDictPlanstore implements java.io.Serializable {

	// Fields

	private TBasisDictPlanstoreId id;
	...
	/** default constructor */
	public TBasisDictPlanstore() {
	}

	/** minimal constructor */
	public TBasisDictPlanstore(TBasisDictPlanstoreId id, String oraarea,
	...
	public TBasisDictPlanstoreId getId() {
		return this.id;
	}

	public void setId(TBasisDictPlanstoreId id) {
		this.id = id;
	}
