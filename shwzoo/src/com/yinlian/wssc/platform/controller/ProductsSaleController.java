 ...
 */
@RestController
@RequestMapping("/platform/sales")
public class ProductsSaleController {
...
//			}
			...
			item.setDesc("商品销量统计异常：" + e.getMessage());
			LogHandle.error(LogType.Product, "商品销量统计异常!", e, "/platform/sales/getsalelist");
		}
		return item;
	}
}
