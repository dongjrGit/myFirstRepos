...
<script src="${ctx }/resource/public/platform/js/SY/ProSpecialEdit.js"></script>
<div class="mainright">
    <div class="l_wzmb">
        <div class="l_wzmbtop">
            <ul>
            ...
            <div class="tjcpxx-con">
                <div class="tjcpxx-con-con">
                    <form id="form">
                    	...
                    	<input type="hidden" id="isby" value="${isby}">
                       <%--  <div class="tjcpxx-con-mk1">
                        ...
                        <div class="tjcpxx-con-mk1" name="fltype" id="spname" style="">
                         ...
                         <ad>
                            ...
                            <div name="spu_name_select" style="width: 160px;left: inherit;" >
                                <ul>
...
<script type="text/javascript">
    ...
    function returnhref(topicid,spmark,type,fatherid){
    	if(spmark==13){
			window.location.href = "/platform/topic/tsdqprolist?pagetype=1";
    	}else if(spmark==6){
    			window.location.href = "/platform/topic/tsdqprolist?pagetype=2";
    	}else if(spmark==7){
    			window.location.href = "/platform/topic/tsdqprolist?pagetype=3";
    	}else if(spmark==14){
    			window.location.href = "/platform/topic/tsdqprolist?pagetype=4";
    	}else if(spmark==3){
    			window.location.href = "/platform/topic/tsdqprolist?pagetype=5";
    	}else if(spmark==15){
			window.location.href = "/platform/topic/tsdqprolist?pagetype=6";
		}else if(spmark==16){
			window.location.href = "/platform/topic/tsdqprolist?pagetype=7";
		}
	}
</script>
