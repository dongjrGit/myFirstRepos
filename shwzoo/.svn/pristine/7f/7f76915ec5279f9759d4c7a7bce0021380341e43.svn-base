                    ...
                    <form id="form" method="post">
                            <div class="tjcpxx-con-mk1">
                                ...
                                <div class="tjcpxx-con-form1">
                                    ...
                                    <select name="firstID" id="firstID" disabled onchange="Class.firstChange(Class.callback, 'fc')">
                                    ...
                                    <select name="secondID" id="secondID" disabled onchange="Class.firstChange(Class.callback, 'sc')">
...
<script>
    function formCancel() {
        ...
        location.href = "/platform/product/class_specslist?cid="+$("#ClassID").val();
