...
<script type="text/javascript">
    function formSubmit() {
        ...
        $.ajax({
            url: "/seller/shopproduct/editSpuImage",
            data: $("#form").serialize(),
            type: "Post",
            dataType: "json",
...
<div id="container">
    ...
    <div class="allcon">
        <div class="position">
            您所在的位置：商品管理 &gt; 商品图片管理 &gt; 商品图片编辑
        </div><!--所在位置信息  结束 -->
        <div class="zhgl-con">
            <div class="zhgl-con-top">
                <div class="zhgl-con-top-title">商品图片编辑</div>
            </div>
                ...
                <form id="form">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="text-inp-big" id="orderby" name="orderby" type="text" value="${img.orderby}">
                            </td>
                        </tr>
