...
<div class="mainright">
	...
	<div class="account-form">
		<span>活动编号：<input type="text" id="num" class="inp-seller" />
		<input type="hidden" id="type_select" value="3" />
		</span> 
		...
		<input type="text" id="ends" class="Wdate"
			...
			<input class="inquire chaxun" name="btnadd" type="button" value="+添加中绿活动">
	</div>
			...
			<tbody id="datalist">
				<script id="spikelist" type="text/html">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="yxgl_ExcitingEdit?id={{spike.id}}"><span class="shenlan">编辑</span></a>
                            <span class="marrig35"></span>
                            <a href="javascript:void(0);" class="del" data="{{spike.id}}"><span class="shenlan">删除</span></a>
                            <span class="marrig35"></span>
                            <a href="yxgl_SpikeImgList?id={{spike.id}}"><span class="shenlan">图片管理</span></a>    
                            <span class="marrig35"></span>
                            <a href="yxgl_ExcitingUserList?id={{spike.id}}"><span class="shenlan">参与用户</span></a> 
                        </td>
                    </tr>
                    {{/each}}
                </script>
