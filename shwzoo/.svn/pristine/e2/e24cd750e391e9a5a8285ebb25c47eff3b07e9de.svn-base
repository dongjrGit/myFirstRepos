<!-- @{
    ViewBag.Title = "店铺管理&gt;店铺管理&gt;店员列表&gt;修改员工密码";
...
<script src="/resource/public/platform/js/shop/shopemployeepwdupdate.js"></script>
<div class="mainright">
    <div class="l_wzmb">
        <div class="l_wzmbtop">
            <ul>
        ...
        <div class="tjcpxx-con-con">
            <form id="updateemployeepwdForm" action="#" method="post">
