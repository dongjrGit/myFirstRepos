...
<script
	src="${pageContext.request.contextPath }/resource/public/platform/js/ControlPanel/manager_role.js"></script>
	...
	<div class="l_wzmb">
		<div class="l_wzmbtop">
			...
			<c:choose>
			 ...
			 <li class="sj_hover"><a href="javascript:void(0);">平台角色添加</a><span
					class="sj-img"></span></li>
			 </c:when>
			 <c:otherwise>
			 <li class="sj_hover"><a href="javascript:void(0);">平台角色编辑</a><span
					class="sj-img"></span></li>
			 </c:otherwise>
			</c:choose>
			</ul> 
					...
					<form id="form" method="post">
						...
						<div class="tjcpxx-con-mk1">
							<div class="tjcpxx-con-form-title">
								<label><span class="red marrig5">*</span>角色名称：</label>
							</div>
							<div class="tjcpxx-con-form1">
								<input class="tjcpxx-fprm-inp" name="name" type="text"
									value="${data.name }"> <input name="id" type="hidden"
									value="${data.id }" />
							</div>
						</div>
						<!--tjcpxx-con-mk stop -->
...
<script>
	function formCancel() {
		location.href = "control_RoleList";
	}
</script>
