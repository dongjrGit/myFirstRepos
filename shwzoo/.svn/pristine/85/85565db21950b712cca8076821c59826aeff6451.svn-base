				...
				<div class="tjcpxx-con-con">
					<div class="tjcpxx-con">
						...
						<div class="tjcpxx-con-mk">
							...
							<div class="tjcpxx-con-form">
								<input class="tjcpxx-fprm-inp" name="tnum" type="text" value="${sku.ticketnum}">
							</div>
						</div>
				...
				<div class="tjcpxx-con-con" style="width:100%;">
				    <div class="tjcpxx-con">
						...
						<div class="tjcpxx-con-form-title" style="padding-top: 3px;"><span class="red marrig5">*</span>日期：</div>
                            <div class="tjcpxx-con-form">
                               	<select id="showy" name="showy" class="the-form-select-one" disabled >
								...
								<select id="showm" name="showm" class="the-form-select-one"  disabled>
					 ...
					 <div class="tjcpxx-con">
                            <div class="tjcpxx-con-form-title"></div>
                            <div class="tjcpxx-con-form " style="padding:8px 0">
                                    <input id='isday' type='checkbox' <c:if test="${spu.istoday==1 }"> checked </c:if> ><span>购买当天票</span>                               
