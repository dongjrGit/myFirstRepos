...
<script src="/resource/public/platform/js/order/businessbillsedit.js"></script>
<div class="mainright">
    <div class="l_wzmb">
        <div class="l_wzmbtop">
            <ul>
                    ...
                    <form id="billcheck">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>转账时间：</td>
                                <td><input type="text" name="tTime" id="tTime" style="float:left;padding-left:10px" class="Wdate" onfocus="WdatePicker({ maxDate: '#F{$dp.$D(\'tTime\')}' })"></td>
                            </tr>
                            <tr>
                                <td>开户银行支行名称</td>
