...
var pack = {
    ...
    getlist: function () {
        ...
        $.ajax({
            url: "/seller/ShopPackage/getSkuByPackageID",
            type: "Post",
    ...
    del: function () {
        if (confirm("确定要删除吗？")) {
            ...
            $.ajax({
                url: "/seller/ShopPackage/deleteSkuPackage",
                type: "Post",
                data: { "id": id },
                dataType: "json",
                success: function (data) {
    ...
    getSkuStartwithName: function (callback, event) {
        ...
        $.ajax({
            url: "/seller/ShopPackage/getSkuStartwithName",
            type: "Post",
    ...
    Save: function () {
        ...
        if (skuid == "" || skuid == undefined) {
            ...
            $.ajax({
                url: "/seller/ShopPackage/addSkuPackage",
                type: "Post",
                data: $("#form").serialize(),
                dataType: "json",
                success: function (data) {
