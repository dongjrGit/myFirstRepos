...
<div class="mainright">
    <div class="l_wzmb">
        <div class="l_wzmbtop">
            <ul>
                <li class="sj_hover"><a href="javascript:void(0);">修改满减活动</a><span class="sj-img"></span></li>
                ...
                <div class="tjcpxx-con-con">
                    <form id="form" method="post">
                        ...
                        <div class="tjcpxx-con-mk">
                            ...
                            <div class="tjcpxx-con-form">
                                <input id="subprice" class="tjcpxx-fprm-inp" style="width:150px;" name="subprice" type="text" value="<fmt:formatNumber value="${data.subvalue}" pattern="0.00"/>">&nbsp;元
                            </div>
                        </div>
                        <div class="tjcpxx-con-mk">
