            ...
            <tbody id="datalist">
                <script id="rolelist" type="text/html">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="control_dpRoleEdit?id={{role.id}}"><span class="shenlan">编辑</span></a>

                            <a href="javascript:void(0);" onclick="del({{role.id}})"><span class="shenlan">删除</span></a>

                            <a href="javascript:void(0);" onclick="getperm('{{role.name}}',{{role.id}},0,3)"><span class="shenlan">编辑权限</span></a>

                            <a href="javascript:void(0);" onclick="getperm('{{role.name}}',{{role.id}},1,3)"><span class="shenlan">查看权限</span></a>
                        </td>
                    </tr>
                    {{/each}}
                </script>
