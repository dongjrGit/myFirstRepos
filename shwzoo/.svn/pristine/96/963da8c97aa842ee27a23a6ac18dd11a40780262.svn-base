...
function saveInfo(id) {
    ...
    $.ajax({
        url: "/platform/businessbillsAjax/editBusinessBill",
        type: "Post",
        data: { "bID": id,"banknum":banknum,"bankname":bankname,"opertor":opertor,"bankusername":bankusername, "remitType": ttype, "transferDate": tTime, "remark": remark, "transferMoney": tmoney },
        dataType: "json",
...
function GetInfo(id) {
    $.ajax({
        url: "/platform/businessbillsAjax/getBillByID",
        type: "Post",
        data: { "id": id },
        dataType: "json",
        success: function (data) {
