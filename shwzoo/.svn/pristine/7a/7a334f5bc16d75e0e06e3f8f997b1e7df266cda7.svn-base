...
<div class="mainright">
	<div class="l_wzmb">
		<div class="l_wzmbtop">
			<ul>
				<li class="sj_hover"><a href="javascript:void(0)">团购商品审核</a><span
				...
				<table id="t1">
					<tbody>
						...
						<tr class="l_nobor">
							...
							<td><input class="preserve-inp marrig35 mar35"
								name="submit_ok" id="submit_ok" onclick="edit(0);" type="button"
								value="同意"> <input class="preserve-inp_hs"
								name="btn_goback" id="btn_goback" type="button"
								onclick="edit(2);" value="不同意">
								<input class="preserve-inp_hs"
								name="btn_goback" id="" type="button" onclick="back();"value="返回"></td>
						</tr>
					</tbody>
				</table>
			...
			success : function(data) {
				if (data.code < 0) {
					...
					Dalert("保存成功！", "", function() {
						window.location.href = "/platform/group/chklist"
					});
				}
			}
		});
