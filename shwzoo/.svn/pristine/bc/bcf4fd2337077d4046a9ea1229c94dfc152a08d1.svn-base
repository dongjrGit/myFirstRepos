...
/**
 * The Class is for Interceptor Login Seller This
 * @author Administrator
 * @version $Id: LoginInterceptor.java, v 0.1 2016年2月22日 下午4:00:42 Administrator Exp $
 */
public class LoginSellerInterceptor implements HandlerInterceptor {
     ...
     * This is Logger.
     */
    private static final Logger logger = LoggerFactory.getLogger(LoginSellerInterceptor.class);
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response,
        ...
        if (url.indexOf(ConstanValue.SELLER_LOGIN_URL) >= 0
            || url.indexOf(ConstanValue.SELLER_TOLOGIN_URL) >= 0
            || url.indexOf(ConstanValue.SELLER_HOME_URL) >= 0
            || url.indexOf(ConstanValue.SELLER_REGISTER_URL) >= 0
            || url.indexOf(ConstanValue.SELLER_TOREGISTER_URL) >= 0
            || url.indexOf(ConstanValue.SELLER_REGSUCCESS_URL) >= 0) {
            return true;
        }
        ...
        if (sessionUser != null && sessionUser.getCode() == 0) {
            ...
            if (userid != null) {
                ...
                if (usertype != null) {
                    if (SessionUtil.checkUserType(request, ConstanValue.SELLER_MARK, usertype)) {
                        return true;
                    }
                }
            }
