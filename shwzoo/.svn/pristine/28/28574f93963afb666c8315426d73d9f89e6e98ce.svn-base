var JIATHIS_CONFIGS = {
	plugin: "http://www.wandaguoji.net/front/templates/js",
    webhost: "http://www.wandaguoji.net",
    lhost: "http://l.jiathis.com",
    codehost: "http://v1.jiathis.com/code",
    sc: false,
    uid: 0,
    ckprefix: "jt_",
    jtcbk: "jtss",
...
(function () {
    ...
    $CKE = {
        ...
        over: function () {
            ...
            if (!clickpopjs) {
                clickpopjs = creElm({
                    src: JIATHIS_CONFIGS.plugin + "/ckepop.js",
                    charset: "utf-8"
                }, "script", head);
        ...
        center: function () {
            ...
            if (!ckcpjs) {
                ckcpjs = creElm({
                    src: JIATHIS_CONFIGS.plugin + "/ckecenterpop.js",
                    charset: "utf-8"
                }, "script", head);
                ...
                list = d.getElementById("ckelist"), clist = list.cloneNode(true), h = clist.getElementsByTagName("input");
    ...
    window.location.host && d.write('<script type="text/javascript" src="' + JIATHIS_CONFIGS.codehost + '/plugin.client.js" charset="utf-8"></script>')
})();
