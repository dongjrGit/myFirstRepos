...
function pagination(pagecount, pageindex, pagerow, callback) {
    ...
    if (totalpage == 0) { }
        ...
        if (totalpage > 0 && pcount <= prow) {
            ...
            htmlpage += "</span>";
            //页面总数和页面跳转
            htmlpage += "<span class='pager-style'>共" + totalpage + "页," + pcount + "条数据</span>";
            ...
            htmlpage += "<span class='pager-hover' >";
            if (pageindex > 1) {
                htmlpage += "<a href='javascript:gotopage(1," + callback + ");'>&lt;&lt;</a>";
                htmlpage += "<a href='javascript:gotopage(" + (parseInt(pageindex) - 1) + "," + callback + ");'>&lt;</a>";
            }
            else {
                htmlpage += "<a class='disadled' >&lt;&lt;</a>";
                htmlpage += "<a class='disadled' >&lt;</a>";
            ...
            for (var i = 1; i <= totalpage; i++) {
                if (pageindex <= 3) {
                    if (i <= 5) {
                        if (i == pageindex) {
                            htmlpage += "<a href='javascript:gotopage(" + i + "," + callback + ");' class='sel'>" + i + "</a>";
                        }
                        else {
                            htmlpage += "<a href='javascript:gotopage(" + i + "," + callback + ");' class=''>" + i + "</a>";
                        }
                    }
                    else {
                        htmlpage += strbreak;
                    ...
                    if (i <= pageindex) {
                        if (i == parseInt(pageindex) - 3) {
                            ...
                            if (parseInt(pageindex) - 5 > 0) {
                                htmlpage += strbreak;
                                htmlpage += "<a href='javascript:gotopage(" + i + "," + callback + ");' >" + i + "</a>";
                            }
                            else {
                                htmlpage += "<a href='javascript:gotopage(" + i + "," + callback + ");' >" + i + "</a>";
                            }
            ...
            if (pageindex == totalpage) {
                ...
                htmlpage += "<a href='javascript:gotopage(" + (parseInt(pageindex) + 1) + "," + callback + ");'>&gt;</a>";
                htmlpage += "<a href='javascript:gotopage(" + totalpage + "," + callback + ");'>&gt;&gt;</a>";
            }
            htmlpage += "</span>";
            //页面总数和页面跳转
            htmlpage += "<span class='pager-style'>共" + totalpage + "页," + pcount + "条数据</span>";
            htmlpage += "到第<input id='pager_jump' type='text'  class='pager-inp'>页";
            htmlpage += " <input name='btnpage' type='button' onclick='javascript:jump_page(" + callback + ");' value='确认' class='pager-but'>";
