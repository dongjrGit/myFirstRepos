...
<script type="text/javascript" src="${ctx }/resource/public/platform/js/news/maplistedit.js"></script>
<script type="text/javascript">
var editor;
...
<div class="mainright">
	<div class="l_wzmb">
		<div class="l_wzmbtop">
			<ul>
				<li class="sj_hover"><a href="javascript:void(0);">添加地图新闻</a><span
			...
			<div class="tjcpxx-con">
				<div class="tjcpxx-con-con">
					...
					<div class="tjcpxx-con-mk1">
						...
						<div class="tjcpxx-con-mk1">
							<div class="tjcpxx-con-form-title"><label>详细地址：</label></div>
							<div class="tjcpxx-con-form1">
						...
						<div class="tjcpxx-con-mk1">
							<div class="tjcpxx-con-form-title"><label>经纬度：</label></div>
							<div class="tjcpxx-con-form1">
...
<script type="text/javascript">
    ...
    function formCancel() {
    	var type=$("#type").val();
    	var ctype=$("#ctype").val();
		location.href = "/platform/news/maplist?type="+type+"&ctype="+ctype;
	}
</script>
