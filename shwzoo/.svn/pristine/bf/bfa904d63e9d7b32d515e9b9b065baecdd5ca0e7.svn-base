...
<script type="text/javascript" src="${ctx }/resource/public/platform/js/news/newsimgedit.js"></script>
...
<div class="mainright">
	<div class="l_wzmb">
		<div class="l_wzmbtop">
			<ul>
				<li class="sj_hover"><a href="javascript:void(0);">添加图片新闻</a><span
...
function delimg(obj)
{
    ...
    function formCancel() {
    	var type=$("#type").val();
    	var ctype=$("#ctype").val();
		location.href = "/platform/news/newsimg?type="+type+"&ctype="+ctype;
	}
</script>
