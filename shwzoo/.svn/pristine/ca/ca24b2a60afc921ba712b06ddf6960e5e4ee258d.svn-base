...
<script type="text/javascript" src="${ctx }/resource/public/platform/js/news/maplist.js"></script>
<div class="clear"></div>
<div class="mainright">
	<div class="clear"></div>
	...
	<div class="account-form">
		...
		<span class="marrig10"></span> <input class="chaxun"
			...
			class="chaxun" name="" onclick="add();" type="button" value="+添加地图新闻">
	</div>
	<!--notice stop -->
	<div class="clear"></div>
	<div class="mar35"></div>
                ...
                <tr>
                    ...
                    <td>
                    	...
                    	{{else }}
                   		...
                   		{{/if}}
						<a href="${ctx }/platform/news/maplistedit?id={{brand.id}}&type={{brand.ctype}}&ctype=${ctype}" title="修改"><span class="shenlan">修改</span></a>
