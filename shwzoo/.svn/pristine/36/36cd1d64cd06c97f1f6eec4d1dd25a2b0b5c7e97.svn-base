...
<div class="mainright">
    ...
    <div class="account-form">
        ...
        <span>
            发放类型：
            <select class="the-form-select-one" id="issue_select">
                    ...
                    <tr>
                        ...
                        <td>
                            {{if coupon.coupontype==0}}
                                                           通用
                            {{else }}
                                                           金额限制，满{{coupon.fullreductionvalue | toFixed}}元使用
                            {{/if}}
                        </td>
                        <td>
                            {{if coupon.gettype==0}}
                        ...
                        <td>
                            {{if coupon.couponusetype==3 || coupon.shopid== ${shopid} }}
                            <a href="yxgl_CouponEdit?id={{coupon.id}}"><span class="shenlan">编辑</span></a>
                            {{else }}
                            <a href="yxgl_CouponDetail?id={{coupon.id}}"><span class="shenlan">查看</span></a>
                            {{/if}}
