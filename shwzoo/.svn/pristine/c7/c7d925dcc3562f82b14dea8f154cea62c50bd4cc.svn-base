...
<script src="${ctx }/resource/public/platform/js/tj/ddtj.js"></script>
<div class="mainright">
    <div class="clear"></div>
    <div class="mar35"></div>
    <div class="account-form">
        ...
        <span>订单年度：</span>
        <input type="text" id="time" onclick="WdatePicker({dateFmt:'yyyy' })" value="" readonly="readonly" class="Wdate" />
        <span class="marrig10"></span>
...
function daochu(){
	if(confirm("确认要导出吗?")){
		...
		location.href="/platform/tj/exportddtjyear?shopid="+sid+"&datef="+timef;
		 }else{
			 alert("请选择年份");
		 }
	}
