...
<script src="${ctx }/resource/public/platform/js/SiteManagement/articleslist.js"></script>
<div class="mainright">
    ...
    <div class="member-xz">
        ...
        <span><input name="" type="text" class="tjcpxx-fprm-inp" style="position:initial" id="ArtTitle" value="请输入文章标题" onfocus="if(this.value==defaultValue) {this.value='';}" onblur="if(!value) {value=defaultValue; this.type='text';}"></span>
