...
(function (factory) {
    ...
    */
    ...
    jQuery.validator.addMethod("checkDataRepeat", function (value, element, param) {
        var result = -1;
        $.ajax(({
            type: "post",
            url: "/Register/CheckUserRepeat",
            dataType: "json",
            async: false,
            data: { usertype: param[0], userkey: value },
    ...
    jQuery.validator.addMethod("checkAccountRepeat", function (value, element, param) {
        var result = -1;
        $.ajax(({
            type: "post",
            url: "/Account/IsExistAccount",
            dataType: "json",
            async: false,
            data: { usertype: param[0], userid: param[1], value: value },
            success: function (rsl) {
                if (rsl.Code == 0) {
                    result = 0;
                }
    ...
    jQuery.validator.addMethod("checkImgCode", function (value, element) {
        ...
        $.ajax(({
            type: "post",
            url: "/Register/CheckVerification",
            dataType: "json",
            async: false,
