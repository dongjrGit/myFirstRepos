...
(function ($) {
    ...
    $.fn.birthdaypicker = function (options) {
        ...
        return this.each(function () {
            ...
            var $wraper = $(_wrap),
                $year = $("<select class='birth-year' name='birth[year]' id='year'></select>"),
                $month = $("<select class='birth-month' name='birth[month]' id='month'></select>"),
                $day = $("<select class='birth-day' name='birth[day]' id='day'></select>");
