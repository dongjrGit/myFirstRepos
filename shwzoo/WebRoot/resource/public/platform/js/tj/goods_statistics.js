...
var glist = {
    ...
    bind: function (index) {
        ...
        var sid = $("#select_seller").attr("data");
        ...
        if (isSearch) {
            ...
            $.ajax({
                url: "/platform/sales/getsalelist",
                type: "Post",
                data: { "page": index, "size": psize, "shopid": sid, "type": stype,
...
$(function () {
    autoxl.bind("select_seller", getShopStartwithName);
