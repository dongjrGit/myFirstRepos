...
var Group = {
		bind : function(index, aftertype) {
			 autoxl.bind("select_shop", Group.getShopStartwithName, true);
			 at = aftertype;
			...
			//var title = $("#stitle").val();
					...
					$.ajax({
						url : "/platform/groupcount/queryGroupOrder",
						type : "Get",
						dataType : "json",
						data : {
							page : index,
...
function refresh(aftertype) {
 ...
 function typeChange() {
    ...
    switch (stype) {
        ...
        case "2": $("#divDay").hide(); $("#thday").hide(); $("#divMonth").hide(); $("#divQuarter").hide(); $("#divYear").hide(); Group.bindsh(1, 2); break;
