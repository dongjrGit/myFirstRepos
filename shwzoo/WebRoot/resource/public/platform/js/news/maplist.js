...
function add(){
	var type=$("#type").val();
	var ctype=$("#ctype").val();
	window.location.href="/platform/news/maplistedit?type="+type+"&ctype="+ctype;
}
...
function setrecommend(id,val){
	$.ajax({
		url:"/platform/news/setrecommend",
		type:"post",
