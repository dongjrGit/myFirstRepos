...
var zengpin = {
    ...
    getlist: function () {
        ...
        $.ajax({
            url: "/platform/fullgift/getGiftList",
            type: "Post",
            data: { "actid": actid },
            dataType: "json",
    ...
    del: function () {
        if (confirm("确定要删除吗？")) {
            ...
            $.ajax({
                url: "/platform/fullgift/deleteGift",
                type: "Post",
                data: { "id": id },
                dataType: "json",
                success: function (data) {
    ...
    getSku: function (callback, event) {
        ...
        $.ajax({
            url: "/platform/sku/getactskubyname",
            type: "Post",
            data: { "name": name },
            dataType: "json",
            success: function (data) {
    ...
    getCoupon: function (callback, event) {
        ...
        if (event)
            name += String.fromCharCode(event.keyCode);
        $.ajax({
            url: "/platform/Coupon/getCouponStartwithName",
            type: "Post",
            data: { "name": name },
            dataType: "json",
            success: function (data) {
...
function setCount(id, ob) {
    var count = $("#" + ob).val();
    $.ajax({
        url: "/platform/fullgift/changeCount",
        type: "Post",
...
function setPoint(id, po) {
    var count = $("#" + po).val();
    $.ajax({
        url: "/platform/fullgift/changePoint",
        type: "Post",
