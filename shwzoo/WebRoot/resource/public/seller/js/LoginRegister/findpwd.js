...
function Submit_Mobile() {
   ...
   // var mobilecodetoken = $("#hidden_mobilecodetoken").val();
    ...
    $.ajax({
        ...
        success: function (rsl) {
            if (rsl.code == 0) {
                window.location.href = "/seller/user/findPwd?setup=3&type=0&userid=" + fk;
            }
            else {
    ...
    $.ajax({
        ...
        success: function (rsl) {
            if (rsl.code == 0) {
                ...
                window.location.href = "/seller/user/findPwd?setup=2&type=0&userid=" + rsl.data;
            }
            else {
                var html = '<label id="data_error" class="error" for="data_error">' + rsl.desc + '</label>';
                $("#td_error").append(html);
...
function Submit_SetNewPwd() {
    ...
    $.ajax(({
        ...
        success: function (rsl) {
            if (rsl.code == 0) {
                window.location.href = "/seller/user/findPwd?setup=4&type=0";
            }
            else {
                var html = '<label id="data_error" class="error" for="data_error">' + rsl.desc + '</label>';
                $("#td_error").append(html);
