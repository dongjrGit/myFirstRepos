...
<div class="mainright">
    ...
    <div class="account-form">
        ...
        <span>选择月份：</span>
        <input type="text" id="time" onclick="WdatePicker({ dateFmt: 'yyyy-MM' })" value="" readonly="readonly" class="Wdate" />
        <span class="marrig10"></span>
...
function daochu(){
	if(confirm("确认要导出吗?")){
		...
		location.href="/platform/tj/exportddtjmonth?shopid="+sid+"&datef="+timef;
		 }else{
			 alert("请选择月份");
		 }
	}
