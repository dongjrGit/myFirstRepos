...
<div class="mainright">
    ...
    <div class="account-form">
        <span>统计类型：</span>
        <input type="hidden" id="aft" value="1" />
        ...
        <span class="marrig10"></span>
        <input class="inquire" name="search" type="button" onclick="aftersearch(1)" value="查询">
    </div>
    <div class="clear"></div>
    <div class="mar35"></div>
    <div class="table-con">
            ...
            <tbody id="datalist">
                <script id="ddlist" type="text/html">
                    ...
                    <tr>
                        ...
                        {{/if}}
                        <td>{{saleorder.count_TKSQ}}/{{saleorder.money_TKSQ | toFixed}}</td>
                        <td>{{saleorder.count_TK}}/{{saleorder.money_TK | toFixed}}</td>
                    </tr>
                    {{/each}}
                </script>
            </tbody>
