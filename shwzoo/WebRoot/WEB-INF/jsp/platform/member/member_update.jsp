...
<script type="text/javascript" src="/resource/ajaxfileupload.js"></script>
 <script type="text/javascript" src="/resource/public/platform/js/member/memberupdate.js"></script> 
...
<div class="mainright">
    <div class="l_wzmb">
        <div class="l_wzmbtop">
            <ul>
                <li class="sj_hover"><a href="javascript:void(0)">编辑会员</a><span class="sj-img"></span></li>
            </ul>
        </div><!--l_wzmbtop   stop -->
        <div class="tjcpxx-con-con">
            <form id="updatememberForm" action="#" method="post" onsubmit="return check();">

                <div class="tjcpxx-con-mk1">
                    <div class="tjcpxx-con-form-title1"><label><span class="red marrig5">*</span>用户名：</label></div>
                    <div class="tjcpxx-con-form1">
                        <input class="tjcpxx-fprm-inp" name="text_username" id="text_username" type="text">
                    </div>
                </div><!--tjcpxx-con-mk stop -->
                <!--<div class="tjcpxx-con-mk1">
                    <div class="tjcpxx-con-form-title1"><label><span class="red marrig5">*</span>登录密码：</label></div>
                    <div class="tjcpxx-con-form1">
...
<!--                <div class="tjcpxx-con-mk1">
                    <div class="tjcpxx-con-form-title1"><label>固定电话：</label></div>
                    <div class="tjcpxx-con-form1">
                        <input class="tjcpxx-fprm-inp" name="text_tel" id="text_tel" type="text">
                    </div>
                </div><!--tjcpxx-con-mk stop -->
  ...
  <!--              <div class="tjcpxx-con-mk1">
                    ...
                    <div class="tjcpxx-con-form1">
                        <input class="tjcpxx-fprm-inp" name="text_address" id="text_address" type="text">
                    </div>
                </div><!--tjcpxx-con-mk stop -->
  <!--             <div class="tjcpxx-con-mk1">
                    <div class="tjcpxx-con-form-title1"><label>邮政编码：</label></div>
                    <div class="tjcpxx-con-form1">
                        <input class="tjcpxx-fprm-inp" name="text_postcode" id="text_postcode" type="text">
                    </div>
                </div><!--tjcpxx-con-mk stop -->
                
   <!--           <div class="tjcpxx-con-mk1">
                    <div class="tjcpxx-con-form-title1"><label>证件：</label></div>
                    <div class="tjcpxx-con-form1">
                        <select id="select_cardtype" class="the-form-select-one select_cardtype">
                            <option value="-1">请选择</option>
                        ...
                        <input class="tjcpxx-fprm-inp" name="text_card" id="text_card" type="text">
                    </div>
                </div><!--tjcpxx-con-mk stop -->
 <!--               <div class="tjcpxx-con-mk1">
                    <div class="tjcpxx-con-form-title1"><label>月收入水平：</label></div>
                    <div class="tjcpxx-con-form1">
                        <select id="select_incomemonth" class="the-form-select-one">
                            <option value="-1">请选择</option>
                ...
                <div class="tjcpxx-con-mk1">
                    <div class="tjcpxx-con-form-title1"></div>
                    <div class="tjcpxx-con-form1 huise" style="padding-top:10px;">
                        <input type="hidden" id="hidden_memberid" value="" />
                        <input class="preserve-inp" name="submit_ok" id="submit_ok" type="button" value="保存">
