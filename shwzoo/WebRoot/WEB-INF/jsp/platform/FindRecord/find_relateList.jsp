...
<script src="/resource/public/platform/js/Findrecord/find_relateList.js"></script>
<div class="mainright">
    ...
    <div class="account-form">
     ...
     <input type="hidden" id="type" name="type" value="${type}">
      ...
      <!--   <span class="marrig10"></span>
        ...
        <span class="marrig10"></span>
        <a href="javascript:;" target="_self"><input class="chaxun" name="add" type="button" value="+添加关联发现信息"></a>
        <a href="javascript:;" target="_self"><input class="chaxun" name="back" type="button" onclick="back()" value="返回"></a>
        ...
        <table class="data_list">
            ...
            <script id="SpecialProlist" type="text/html">
                ...
                <tr>
                    ...
                    <td>
                        <a href="/platform/find/showFindEdit?findid={{pf.findid}}&id={{pf.id}}&type={{pf.type}}"><span  class="shenlan" title="修改">修改</span></a>
