...
<div class="mainright">
    ...
    <div class="notice-fenlei">
        ...
        <a href="goods_zySkuAdd?spuid=${spu.id}" target="_self"><input class="chaxun addnew_button" type="button" value="+添加商品及规格信息"></a>
        <a href="javascript:fh()" target="_self"><input class="inquire" name="" type="button" value="返回直营商品列表"></a>
        ...
        <table class="data_list">
            ...
            <c:forEach var="sku" items="${skulist }">
                   <tr>
                        ...
                        <td>${sku.warnnum }</td>
                        <td>
                            <a href="goods_skuImgList?skuid=${sku.id}"><span class="shenlan">图片管理</span></a>
                            <a href="goods_zySkuEdit?id=${sku.id}"><span class="shenlan">商品及规格编辑</span></a>
