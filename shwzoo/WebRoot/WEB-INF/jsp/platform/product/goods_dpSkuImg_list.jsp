...
<div class="mainright">
	...
	<div class="notice-fenlei">
		...
		<!-- <a href="goods_skuImgAdd?skuid=${sku.id}" target="_self"><input class="inquire" name="" type="button" value="+添加图片"></a>  -->
		
			<a href="goods_dpSkulist?spuid=${sku.spuId}"><input class="inquire" name="backPage"
