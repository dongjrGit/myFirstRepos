...
<script type="text/javascript">
    function formSubmit() {
        ...
        //TODO 前端校验数据格式
        $.ajax({
            url: "/platform/brand/updateBrand",
            data: $("#form").serialize(),
            type: "Post",
            dataType: "json",
                    ...
                    <form id="form" >
                        <div class="tjcpxx-con-mk1">
                            ...
                            <div class="tjcpxx-con-form1">
                                <input class="tjcpxx-fprm-inp" name="name" value="${brand.name }" type="text">
                        ...
                        <div class="tjcpxx-con-mk1">
                            ...
                            <div class="tjcpxx-con-form1">
                                <div class="tjcpxx-con-form-upimg">
                                    <img id="loadimg" width="120px" height="115px" src="<%=path %>${brand.img}" />
                                </div>
                        ...
                        <div class="tjcpxx-con-mk1">
                            ...
                            <div class="tjcpxx-con-form1">
                                <input class="tjcpxx-fprm-inp" name="officialurl" value="${brand.officialurl }" type="text">
                            </div>
                        </div><!--tjcpxx-con-mk stop -->
                        <div class="tjcpxx-con-mk1">
                            <div class="tjcpxx-con-form-title1"><label>品牌备注：</label></div>
                            <div class="tjcpxx-con-form1">
                                <textarea class="tjcpxx-con-form1-text" name="description">${brand.description }</textarea>
                            </div>
                        </div><!--tjcpxx-con-mk stop -->
                        <div class="tjcpxx-con-mk1">
                            <div class="tjcpxx-con-form-title1"></div>
        ...
        $(".tjcpxx-con-form-upthis").click(function () {
            $.ajaxFileUpload({
                ...
                success: function (result) {
                    ...
                    if (result.code == 0){
                    	Dalert("上传成功");                    	
                        $("#loadimg").attr("src", $("#imgsrc").val()+result.data);
                    }
                    else
                    {
                   	 $("#loadimg").attr("src", "");
