...
<div class="mainright">
    <div class="l_wzmb">
        <div class="l_wzmbtop">
            <ul>
                <li class="sj_hover"><a href="javascript:void(0);">添加满减活动</a><span class="sj-img"></span></li>
            </ul>
        </div><!--l_wzmbtop   stop -->
        <div class="tjcpxx">
                ...
                <div class="tjcpxx-con-con">
                    <form id="form" method="post">
                        ...
                        <div class="tjcpxx-con-mk">
                            ...
                            <div class="tjcpxx-con-form">
                                <input id="subprice" class="tjcpxx-fprm-inp" style="width:150px;" name="subprice" type="text" value="">&nbsp;元
                            </div>
                        </div>
                        <div class="tjcpxx-con-mk">
