...
<div class="mainright">
	<div class="l_wzmb">
		<div class="l_wzmbtop">
			<ul>
				<li class="sj_hover"><a href="javascript:void(0);">编辑团购</a><span
					...
					<form id="form" method="post">
						<div class="tjcpxx-con-mk1">
							...
							<div class="tjcpxx-con-form1">
								<input id="title" class="tjcpxx-fprm-inp" name="title"
									type="text" value="${data.title }"> <input id="id"
						...
						<div class="tjcpxx-con-mk1">
							...
							<div class="tjcpxx-con-form1">
								<input id="cprice" class="tjcpxx-fprm-inp" style="width: 150px;"
						...
						<div class="tjcpxx-con-mk1">
							...
							<div class="tjcpxx-con-form1">
								<input id="oprice" class="tjcpxx-fprm-inp" style="width: 150px;"
						...
						<div class="tjcpxx-con-mk1">
							...
							<div class="tjcpxx-con-form1">
								<input id="stock" class="tjcpxx-fprm-inp" style="width: 150px;"
						...
						<div class="tjcpxx-con-mk">
							...
							<div class="tjcpxx-con-form">
								<input id="detaildesc" class="tjcpxx-fprm-inp" name="detaildesc"
						...
						<div class="tjcpxx-con-mk">
							...
							<div class="tjcpxx-con-form">
								<input id="listdesc" class="tjcpxx-fprm-inp" name="listdesc"
