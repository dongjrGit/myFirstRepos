                    ...
                    <form id="form" method="post">
                      ...
                      <!--   @*优惠卷类型*@ -->
                        ...
                        <div class="tjcpxx-con-mk1">
                            ...
                            <div class="tjcpxx-con-form1">
                                <input id="shopid" name="shopid" type="hidden" value="${data.shopid}"/>
                         ...
                         <div class="tjcpxx-con-mk1">
                            ...
                            <div class="tjcpxx-con-form1">
                                ...
                                <input id="spuid" name="spuid" type="hidden" value="${data.usetypeid}"/>
                                <input id="select_spu" type="text" class="tjcpxx-fprm-inp" readonly value="${data.spuname}" />
                            </div>
                        </div>
                        </c:when>
                        ...
                        <div class="tjcpxx-con-mk1">
                            <div class="tjcpxx-con-form-title"><label><span class="red marrig5">*</span>所属店铺：</label></div>
                            <div class="tjcpxx-con-form1">
                              <input id="usetype" name="usetype" type="hidden" value="2">
                                <input id="shopid" name="shopid" type="hidden" value="${data.usetypeid}"/>
                                  <input id="spuid" name="spuid" type="hidden" value="${0}"/>
                                <input id="select_shop" type="text" class="tjcpxx-fprm-inp" readonly value="${data.shopname}" />
                            </div>
                        </div>
                        </c:when>
                        <c:otherwise>
                          <div class="tjcpxx-con-mk1">
                            ...
                            <div class="tjcpxx-con-form1">
                                <select id="usetype" name="usetype" class="the-form-select" >
