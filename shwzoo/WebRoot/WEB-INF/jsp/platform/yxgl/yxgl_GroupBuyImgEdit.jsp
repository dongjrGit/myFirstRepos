...
<script type="text/javascript">
    function backhref() {
        window.location.href = "yxgl_GroupBuyImgList?id=" + $("#groupid").val();
    }
</script>
...
<div class="mainright">
	<div class="l_wzmb">
		<div class="l_wzmbtop">
			<ul>
				<li class="sj_hover"><a href="javascript:void(0);">编辑团购图片信息</a><span
					...
					<form id="form">
						...
						<div class="tjcpxx-con-mk">
							<div class="tjcpxx-con-form-title">
								<label><span class="red marrig5">*</span>团购图片：</label>
							</div>
