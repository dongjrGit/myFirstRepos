...
<script src="${pageContext.request.contextPath }/resource/public/platform/js/yxgl/manjianSave.js"></script>
...
<div class="mainright">
    <div class="l_wzmb">
        <div class="l_wzmbtop">
            <ul>
                <li class="sj_hover"><a href="javascript:void(0);">查看满减活动</a><span class="sj-img"></span></li>
                ...
                <div class="tjcpxx-con-con">
                    <form id="form" method="post">
                        <div class="tjcpxx-con-mk">
                            <div class="tjcpxx-con-form-title"><label><span class="red marrig5">*</span>编号：</label></div>
                            <div class="tjcpxx-con-form">
                                <input id="num" class="tjcpxx-fprm-inp" name="num" disabled type="text" value="${data.actnum }">
                        ...
                        <div class="tjcpxx-con-mk">
                            ...
                            <div class="tjcpxx-con-form">
                                <input id="name" class="tjcpxx-fprm-inp" name="name" type="text" disabled value="${data.actname }">
                            </div>
                        </div>

                        <div class="tjcpxx-con-mk">
                            <div class="tjcpxx-con-form-title"><label><span class="red marrig5">*</span>满减类型：</label></div>
                            <div class="tjcpxx-con-form">
                                <select name="acttype" id="acttype" class="the-form-select" onchange="activity.TypeChange()" disabled>
                         ...
                         <div id="divje" class="tjcpxx-con-mk">
                                ...
                                <div class="tjcpxx-con-form">
                                    <input id="fullprice" class="tjcpxx-fprm-inp" style="width:150px;" 
                                    name="fullprice" disabled type="text" value="<fmt:formatNumber value="${data.fullvalue}" pattern="0.00"/>">&nbsp;元
                                </div>
                            </div>
                         </c:when>
                         <c:otherwise>
                         <div id="divsp">
                                <div class="tjcpxx-con-mk1">
                                    ...
                                    <div class="tjcpxx-con-form1">
                                       <input type="hidden" value="${data.spuid }" name="spuid" />
                                        ...
                                        <select name="firstID" id="firstID" onchange="Class.firstChange(Class.callback, 'fc')" disabled>
                                        ...
                                        <select name="secondID" id="secondID" onchange="Class.firstChange(Class.callback, 'sc')" disabled>
                                        ...
                                        <select name="thirdID" id="thirdID" onchange="activity.getSPU()" disabled>
                                ...
                                <div class="tjcpxx-con-mk1">
                                    ...
                                    <div class="tjcpxx-con-form1">
                                        <input id="select_spu" type="text" disabled class="tjcpxx-fprm-inp" value="${spuname }" />
                                    </div>
                                </div>
                                <div class="tjcpxx-con-mk">
                                    <div class="tjcpxx-con-form-title"><label><span class="red marrig5">*</span>满足条件：</label></div>
                                    <div class="tjcpxx-con-form">
                                        <input id="count" class="tjcpxx-fprm-inp" style="width:150px;" disabled name="count" type="text" value="${data.count }">&nbsp;件
                                    </div>
                                </div>
                            </div>
                         </c:otherwise>
                        ...
                        <div class="tjcpxx-con-mk">
                            <div class="tjcpxx-con-form-title"><label><span class="red marrig5">*</span>减免金额：</label></div>
                            <div class="tjcpxx-con-form">
                                <input id="subprice" class="tjcpxx-fprm-inp" style="width:150px;" disabled name="subprice" type="text" value="<fmt:formatNumber value="${data.subvalue}" pattern="0.00"/>">&nbsp;元
                            </div>
                        </div>
                        <div class="tjcpxx-con-mk">
                            <div class="tjcpxx-con-form-title"><label><span class="red marrig5">*</span>开始时间：</label></div>
                            <div class="tjcpxx-con-form">
                                <input type="text" name="start" id="start" class="Wdate2" disabled 
                        ...
                        <div class="tjcpxx-con-mk">
                            ...
                            <div class="tjcpxx-con-form">
                                <input type="text" name="end" id="end" class="Wdate2" disabled 
                        ...
                        <div class="tjcpxx-con-mk">
                            ...
                            <div class="tjcpxx-con-form">
                                <input id="stock" class="tjcpxx-fprm-inp" style="width:150px;" name="stock" disabled type="text" value="${data.stock }">&nbsp;件
                            </div>
                        </div>
                       <%--  <div class="tjcpxx-con-mk">
