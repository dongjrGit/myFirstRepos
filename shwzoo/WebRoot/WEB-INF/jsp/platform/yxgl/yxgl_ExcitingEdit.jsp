				...
				<div class="tjcpxx-con-con">
					<form id="form" method="post">
						...
						<div id="divimg" class="tjcpxx-con-mk">
						 ...
						 <div id="divlist" class="tjcpxx-con-mk1" style="display:none;">
                            <div class="tjcpxx-con-form-title"><label><span class="red marrig5">*</span>列表页简介：</label></div>
                            <div class="tjcpxx-con-form">
                                <input id="listdesc" class="tjcpxx-fprm-inp" name="listdesc" type="text" value="${data.listdesc}">
                            </div>
                         </div>
						  <div id="divdetail" class="tjcpxx-con-mk1" style="display:none;">
                            ...
                            <div class="tjcpxx-con-form">
								...
								<input class="tjcpxx-fprm-inp" name="detaildesc" type="hidden" value="${data.detaildesc}" >
							</div>
                            </div>
                        </div>
						<div class="tjcpxx-con-mk1">
...
<script>
	...
	function formCancel() {
		location.href = "yxgl_ExcitingList";
	}
	var editor;
	KindEditor.ready(function(K) {
		...
		if ($("input[name=detaildesc]").val() != ""
			&& $("input[name=detaildesc]").val() != undefined) {
		editor.html($("input[name=detaildesc]").val());}
	});	
