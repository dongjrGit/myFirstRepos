<!-- @{
    ViewBag.Title = "店铺管理&gt;店铺管理&gt;店员列表&gt;编辑店铺员工";
...
<script type="text/javascript" src="/resource/public/platform/js/shop/shopemployeeupdate.js"></script>
<div class="mainright">
    <div class="l_wzmb">
        <div class="l_wzmbtop">
            <ul>
                <li class="sj_hover"><a href="javascript:void(0)">编辑店铺员工</a><span class="sj-img"></span></li>
            </ul>
        </div><!--l_wzmbtop   stop -->
        <div class="tjcpxx-con-con">
            <form id="addshopEmployeeForm" action="#" method="post" onsubmit="return check();">
                <div class="tjcpxx-con-mk1">
                    ...
                    <div class="tjcpxx-con-form1" id="div_shop">
                        <input type="hidden" id="hidden_shopid" value="" />
               ...
               <!--  <div class="tjcpxx-con-mk1">
                    ...
                    <div class="tjcpxx-con-form1">
                        <input class="tjcpxx-fprm-inp" name="text_loginpwd" id="text_loginpwd" type="text">
                    </div>
                </div>  -->
                <div class="tjcpxx-con-mk1">
