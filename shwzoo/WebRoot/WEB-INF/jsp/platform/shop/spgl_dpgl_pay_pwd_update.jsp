...
<script src="${ctx }/resource/public/platform/js/shop/shoppaypwdupdate.js"></script>
<div class="mainright">
    <div class="l_wzmb">
        <div class="l_wzmbtop">
            <ul>
                <li class="sj_hover"><a href="javascript:void(0)">店铺支付密码修改</a><span class="sj-img"></span></li>
            </ul>
        </div><!--l_wzmbtop   stop -->
        <div class="tjcpxx-con-con">
            <form id="updateshoppwdForm" action="#" method="post">
