...
<script type="text/javascript" src="/resource/public/platform/js/shop/shopfinance.js"></script>
<div class="mainright">
	<div class="clear"></div>
	<div class="account-form">
		<div class="account-form">
		 <span>供应商编号：<input id="select_shop" type="text" class="inp-seller" /></span>
        <span class="marrig10"></span>
		<span>供应商名称：<input id="select_name" type="text" class="inp-seller" /></span>
		<span class="marrig10"></span>
	  <span>
