...
<script type="text/javascript" src="/resource/public/platform/js/shop/shopviolation.js"></script>
<div class="mainright">
    <div class="clear"></div>
    <div class="mar35">
        ...
        <span class="marrig10"></span>
        <span class="notice-fenlei-mk2"><input class="inquire" name="select_button" type="button" value="查询" onclick="ShopViolationList.getShopViolationList(1)"></span>
        <span class="marrig10"></span>
        <a href="/platform/shop/ShopViolationAdd" id="a_addshopviolation"><input class="inquire" name="" type="button" value="+添加违规店铺"></a>
    </div>
            ...
            <script id="shopviolationlist" type="text/html">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="javascript:void(0);" class="a_shopviolationremove"><span class="shenlan">解除违规</span></a>
                        <a href="javascript:void(0);" class="a_shopviolationdelete"><span class="shenlan">删除</span></a>
                    </td>
                </tr>
                {{/each}}
            </script>
