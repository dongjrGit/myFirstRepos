...
<script src="${ctx }/resource/public/platform/js/news/clist.js"></script>
    ...
    <div class="table-con">
        <table class="data_list">
            ...
            <script id="classlist" type="text/html">
                ...
                <tr>
                    <td class="li-he45 text-left"><span class="unwind-two"></span>{{nclass.name}}</td>
                        ...
                        <div class="tab-scale">
                            <table width="100%" style="width:100%">
                                ...
                                <tr class="table-con-mk"  style="border:1px solid #ccc;">
                                    <td class="text-left padleft100" width="40%"><span class="unwind-two" style="margin-top:0px;margin-left:0px;"></span>{{child.name}}</td>
								...
								{{each child.list as childe f}}
 								<tr >
                                    <td class="text-left padleft130" width="40%"><span class="unwind-two" style="margin-top:0px;margin-left:0px;"></span>{{childe.name}}</td>
