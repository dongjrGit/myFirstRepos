...
<script type="text/javascript" src="${ctx }/resource/public/platform/js/news/list.js"></script>
<div class="clear"></div>
<div class="mainright">
	<div class="clear"></div>
	...
	<div class="account-form">
		...
		<span class="marrig10"></span> <input class="chaxun"
			...
			class="chaxun" name="" onclick="add();" type="button" value="+添加新闻">
	</div>
	<!--notice stop -->
	<div class="clear"></div>
	<div class="mar35"></div>
		...
		<table class="data_list">
			...
			<script id="brandlist" type="text/html">
                ...
                <tr>
                    ...
                    <td>
						{{if ${type}==14}}
							<span class="lvs" id="tt_{{brand.id}}"><a data-id="{{brand.id}}" data-status="1" onclick="xgsc({{brand.id}})" class="set" href="javascript:void(0);">相关食材</a></span>
						{{/if}}
						{{if brand.ishead==0}}
                    	...
                    	{{else }}
                   		...
                   		{{/if}}
						<a href="${ctx }/platform/news/listedit?id={{brand.id}}&type={{brand.ctype}}&ctype=${ctype}" title="修改"><span class="shenlan">修改</span></a>
...
<script type="text/javascript">
	...
	function xgsc(id){
		location.href='/platform/news/xgsc?newsid='+id;
	}
</script>