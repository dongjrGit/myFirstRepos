...
<script type="text/javascript" src="${ctx }/resource/public/platform/js/news/slist.js"></script>
...
<div class="mainright">
	...
	<div class="account-form">
		...
		<span class="marrig10"></span> <input class="chaxun"
			...
			class="chaxun" name="" onclick="back();" type="button" value="+添加公告">
	</div>
	<!--notice stop -->
	<div class="clear"></div>
	<div class="mar35"></div>
		...
		<table class="data_list">
			...
			<script id="brandlist" type="text/html">
                ...
                <tr>
                    ...
                    {{/if}}
                    <td>
                        <a href="${ctx }/platform/news/slistedit?id={{brand.id}}&type={{brand.ctype}}&ctype=${ctype}" title="修改"><span class="shenlan">修改</span></a>
