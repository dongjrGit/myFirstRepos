...
<script src="${ctx }/resource/public/platform/js/SY/SubSpecials.js"></script>
<div class="mainright">
<input type="hidden" id="imgsrc" value="<%=path %>" />
    <div class="account-form">
      ...
      <!--   <span>
        ...
        <a href="/platform/topic/showsubAdd?topicid=${topicid}" target="_self"><input class="chaxun" name="add" type="button" value="+添加子专题信息"></a>
