...
<link rel="shortcut icon" type="image/x-icon"
	href="${ctx }/resource/images/favicon_shortcut.ico" />
...
<body>
	...
	<div id="header">
		<div class="wrapper">
			<div class="logo">
				<img src="${ctx }/sv/images/logo_wz.png" width="396" height="90">
			</div>
			<!--logo 结束 -->
			<div class="searh">
			...
			<!--搜索框结束 -->
			<div class="admin">
				<span class="admin-tp"></span> 欢迎${name} <a href="${ctx }/seller/message/showUserMessage"><span
					style="background: url(/sv/images/mess301.png); width: 12px; height: 8px; display: inline-block; margin: 0px 0px 0px 10px;"></span><span
	...
	<div id="container">
		...
		<div class="rightside" id="rightside">
			<iframe src="${ctx }/seller/message/showUserMessage" frameborder="0" marginheight="0"
