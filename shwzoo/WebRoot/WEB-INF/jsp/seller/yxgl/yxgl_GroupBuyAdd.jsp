    ...
    <div class="allcon">
        ...
        <div class="zhgl-con">
            <div class="zhgl-con-top">
                <div class="zhgl-con-top-title">添加团购</div>
                ...
                <div class="zhgl-con-con">
                    <table>
                        <tr>
                            ...
                            <td>
                                <input name="title" type="text" class="text-inp-big" value="">
                            </td>
                        </tr>
                        <tr>
                            <td class="xjdpzzh-left"><span class="red">*</span>现价：</td>
                            <td>
                                <input name="cprice" type="text" class="text-inp-big" style="width:155px;" value="">&nbsp;元
                            </td>
                        </tr>
                         <tr>
                            <td class="xjdpzzh-left"><span class="red">*</span>原价：</td>
                            <td>
                                <input name="oprice" type="text" class="text-inp-big" style="width:155px;" value="">&nbsp;元
                            </td>
                        </tr>
                        <tr>
                            <td class="xjdpzzh-left"><span class="red">*</span>数量：</td>
                            <td>
                                <input name="stock" type="text" class="text-inp-big" style="width:155px;" value="">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input name="detaildesc" type="text" class="text-inp-big" value="">
                            </td>
                        </tr>
                        <tr>
                            <td class="xjdpzzh-left">列表页简介：</td>
                            <td>
                                <input name="listdesc" type="text" class="text-inp-big" value="">
                            </td>
                        </tr>
                        <tr>
							...
							<td><textarea id="content1" name=""
								...
								<input class="text-inp-big" name="content" type="hidden">
							</td>
						</tr>
						<tr>
							...
							<td><textarea id="content2" name=""
									style="width: 450px; height: 200px; visibility: hidden;"></textarea>
								<input class="text-inp-big" name="buynotes" type="hidden">
							</td>
						</tr>
						 <tr>
                            <td class="xjdpzzh-left">随时退：</td>
                            <td>
                                <input name='isanytime' checked type='radio' value='1'><span>是</span>
                                <span class='marrig35'></span>
                                <input name='isanytime' type='radio' value='0'><span>否</span>
                            </td>
                        </tr>
                        <tr>
                            <td class="xjdpzzh-left">支持预约：</td>
                            <td>
                                <input name='isbook' checked type='radio' value='1'><span>是</span>
                                <span class='marrig35'></span>
                                <input name='isbook' type='radio' value='0'><span>否</span>
                            </td>
                        </tr>
                        <tr>
                            <td class="xjdpzzh-left">过期退：</td>
                            <td>
                                <input name='isexpired' checked type='radio' value='1'><span>是</span>
                                <span class='marrig35'></span>
                                <input name='isexpired' type='radio' value='0'><span>否</span>
                            </td>
                        </tr>
                          <tr>
