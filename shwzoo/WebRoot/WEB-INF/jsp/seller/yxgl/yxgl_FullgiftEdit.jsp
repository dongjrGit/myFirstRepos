...
<script src="${pageContext.request.contextPath }/resource/public/seller/js/yxgl/manzengSave.js"></script>
<script type="text/javascript">
    $(document).ready(function () {
        ...
        if ($("#givetype").val() == 0) {
            autoxl.bind("select_givec", activity.getCoupon, true);
        } else {
            autoxl.bind("select_gives", activity.getSku, true);
        }
    });
    function formCancel() {

        location.href = "yxgl_FullgiftList";
...
<div class="container">
    <div class="allcon">
        <div class="position">
            您所在的位置：营销管理 &gt; 满赠活动 &gt; 添加满赠活动
        </div><!--所在位置信息  结束 -->
        <div class="zhgl-con">
            <div class="zhgl-con-top">
                <div class="zhgl-con-top-title">添加满赠活动</div>
                ...
                <div class="zhgl-con-con">
                    <table>
                        <tr>
                            ...
                            <td>
                                <input id="num" class="text-inp-big" style="width:150px;" name="num" type="text" value="${data.actnum }">
                        ...
                        <tr>
                            <td class="xjdpzzh-left"><span class="red">*</span>名称：</td>
                            <td>
                                <input id="name" class="text-inp-big" name="name" type="text" value="${data.actname }">
                            </td>
                        </tr>
                        <tr>
                            <td class="xjdpzzh-left"><span class="red">*</span>满赠类型：</td>
                            <td>
                        ...
                        <c:when test="${data.usetype==0 }">
                          <tr>
                                ...
                                <td>
                                    <input id="fullprice" class="text-inp-big" style="width:150px;" 
                                    name="fullprice" type="text" value="<fmt:formatNumber value="${data.fullvalue}" pattern="0.00"/>">&nbsp;元
                                </td>
                            </tr>
                        </c:when>
                        ...
                        <tbody id="divsp">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="tjcpxx-con-form1">
                                            <input id="select_spu" type="text" class="text-inp-big" value="${spuname }" data="${data.spuid }" />
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td><input id="count" class="text-inp-big" style="width:150px;" 
                                    name="count" type="text" value="${data.count }">&nbsp;件</td>
                                </tr>
                            </tbody>
                        </c:otherwise>
                        </c:choose>                   
                        ...
                        <tr>
                            ...
                            <td>
                                <input id="stock" class="text-inp-big" style="width:150px;" name="stock" 
                      ...
                      <%--   <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input id="action" type="hidden" value="updatefullgift">
