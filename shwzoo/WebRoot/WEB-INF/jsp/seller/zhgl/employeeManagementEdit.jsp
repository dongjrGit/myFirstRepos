...
<script type="text/javascript" src="${ctx }/resource/public/seller/js/Zhgl/EmployeeManagementEdit.js"></script>
<div id="container">
    <div class="allcon">
        <div class="position">
            您所在的位置：账号管理 &gt; 账号管理 &gt; 角色维护 &gt; 编辑子账号
        </div><!--所在位置信息  结束 -->
        <div class="zhgl-con">
            <div class="zhgl-con-top">
                <div class="zhgl-con-top-title">编辑子账号</div>
                ...
                <form id="addshopEmployeeForm" action="#" method="post" onsubmit="return check(); "> <!--  -->
                    <table>
                      ...
                      <!--  <tr>
                                ...
                                <td><input id="text_loginpwd" name="text_loginpwd" type="text" class="text-inp-big"></td>
                            </tr> -->
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="padding-top:30px;">
                                <input name="submit_ok" type="submit" value="保存" id="submit_ok" class="big-but">
