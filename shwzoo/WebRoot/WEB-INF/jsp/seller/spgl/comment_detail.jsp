...
<script type="text/javascript" src="/resource/public/seller/js/spgl/commentdetail.js"></script>
<div class="mainright">
    <div class="clear"></div>
    <div class="position">您所在的位置：商品管理 &gt; 标准商品管理 &gt; 商品评论明细</div>
    <div class="l_wzmbtop">
        <input class="but-comm" name="btn_goback" id="btn_goback" type="button" value="返回" style="float:right;margin-bottom:3px;">
    </div><!--l_wzmbtop   stop -->
                                ...
                                <div class="comment-dpplb-con">
                                    ...
                                    <div class="time-reply">
                                        ...
                                        <div class="reply-con">
                                            ...
                                            <input class="big-but marrig35 mar35 reply_ok" name="" type="submit" value="确认">
                                            <input class="big-but-huise reply_canle" name="" type="button" value="取消">
                                        </div>
                                        <div class="clear"></div>
                                    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#btn_goback").bind("click", function () {
            window.location.href = "/seller/productshop/evaluation_list";
        });
        //初始化
        Init.bind();
    })
