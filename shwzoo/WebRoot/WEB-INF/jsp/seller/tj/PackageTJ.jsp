    ...
    <div class="allcon">
        ...
        <div class="l_khqyfb FastSelect">
         <input type="hidden" id="shopid" value="${shopid}">
            ...
            <div class="mt15">
                组合编号：<input id="num" type="text" class="text-inp" />
        ...
        <div class="l_sjhzxsmx fix">
            <ul id="datasumtimedisplay">
                <script id="datasumtime" type="text/html">
                    <li>组合商品活动数：<span class="red">{{list.actCount}}</span></li>
       ...
       <!--  <div class="l_zlb"><ad class="counttop10">涉及订单量TOP10</ad></div>
        ...
        <div class="l_zlb"><ad class="commoditytime">组合商品明细</ad></div>
                ...
                <tbody id="datalist">
                    <script id="detaillist" type="text/html">
                        ...
                        <tr>
                            ...
                            {{if detail.activityType==0}}
                            <td>限时抢购</td>
                            {{else}}
                            <td>组合商品</td>
                            {{/if}}
                            <td>{{detail.skuCount}}</td>
...
<script type="text/javascript">
    ...
    function getdatalist(index) {
        ...
        if (timef == undefined || timef == "" || timet == undefined || timet == "") {
            ...
            $.ajax({
                url: "/seller/analysis/getPackageDetail",
                type: "Post",
                data: { "page": index,
                	"size": psize,
                	"starttime": timef,
    ...
    function setdatasumtime() {
        ...
        $(".commoditytime").html("组合商品明细（" + $("#starttime").val() + "至" + $("#endtime").val() + ")");
    }
</script>