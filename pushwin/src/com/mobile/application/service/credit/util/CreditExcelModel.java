package com.mobile.application.service.credit.util;
...
@Service
public class CreditExcelModel {
	public JSONArray readExcelModel() throws IOException{
		String creditModelFile = SpringProperty.props.getProperty("RootPath") + SpringProperty.props.getProperty("creditModelFile");
