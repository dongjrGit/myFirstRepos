...
/**
 * TBasisDictPlanstoregoodId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class TBasisDictPlanstoregoodId implements java.io.Serializable {
	...
	/** default constructor */
	public TBasisDictPlanstoregoodId() {
	}

	/** full constructor */
	public TBasisDictPlanstoregoodId(String businid, String storetypeid) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TBasisDictPlanstoregoodId))
			return false;
		TBasisDictPlanstoregoodId castOther = (TBasisDictPlanstoregoodId) other;
