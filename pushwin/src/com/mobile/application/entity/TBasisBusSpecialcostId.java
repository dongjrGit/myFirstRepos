...
/**
 * TBasisBusSpecialcostId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class TBasisBusSpecialcostId implements java.io.Serializable {
	...
	/** default constructor */
	public TBasisBusSpecialcostId() {
	}

	/** full constructor */
	public TBasisBusSpecialcostId(String businid, String businidBracnch) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TBasisBusSpecialcostId))
			return false;
		TBasisBusSpecialcostId castOther = (TBasisBusSpecialcostId) other;
