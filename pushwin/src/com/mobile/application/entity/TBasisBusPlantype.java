...
/**
 * TBasisBusPlantype entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "T_BASIS_BUS_PLANTYPE")
public class TBasisBusPlantype implements java.io.Serializable {

	// Fields

	private TBasisBusPlantypeId id;
	...
	private String child_product;	//新增字段（用于还款计划和可售产品关联）0301代表随鑫贷 PLON诚意贷
	...
	/** default constructor */
	public TBasisBusPlantype() {
	}

	/** minimal constructor */
	public TBasisBusPlantype(TBasisBusPlantypeId id, String businid,
	...
	public TBasisBusPlantypeId getId() {
		return this.id;
	}

	public void setId(TBasisBusPlantypeId id) {
		this.id = id;
	}
	...
	@Column(name = "CHILD_PRODUCT", length = 5)
	public String getChild_product() {
		return child_product;
	}

	public void setChild_product(String child_product) {
		this.child_product = child_product;
	}
	
	@Column(name = "YOUHUI_CODE", length = 30)
	public String getYouhui_code() {
		return youhui_code;
	}

	public void setYouhui_code(String youhui_code) {
		this.youhui_code = youhui_code;
	}
