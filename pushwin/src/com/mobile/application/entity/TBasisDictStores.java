...
/**
 * TBasisDictStores entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "T_BASIS_DICT_STORES")
public class TBasisDictStores implements java.io.Serializable {
	...
	/** default constructor */
	public TBasisDictStores() {
	}

	/** minimal constructor */
	public TBasisDictStores(String businid, String businidbranch,
