...
/**
 * TBasisBusPurchasecode entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "T_BASIS_BUS_PURCHASECODE")
public class TBasisBusPurchasecode implements java.io.Serializable {

	// Fields

	private TBasisBusPurchasecodeId id;
	...
	/** default constructor */
	public TBasisBusPurchasecode() {
	}

	/** minimal constructor */
	public TBasisBusPurchasecode(TBasisBusPurchasecodeId id,
	...
	/** full constructor */
	public TBasisBusPurchasecode(TBasisBusPurchasecodeId id, String businname,
	...
	public TBasisBusPurchasecodeId getId() {
		return this.id;
	}

	public void setId(TBasisBusPurchasecodeId id) {
		this.id = id;
	}
