...
/**
 * TBasisDictCompabymemo entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "T_BASIS_DICT_COMPABYMEMO")
public class TBasisDictCompabymemo implements java.io.Serializable {

	// Fields

	private TBasisDictCompabymemoId id;
	...
	/** default constructor */
	public TBasisDictCompabymemo() {
	}

	/** minimal constructor */
	public TBasisDictCompabymemo(TBasisDictCompabymemoId id,
			String busintypeid, String status) {
		this.id = id;
	...
	/** full constructor */
	public TBasisDictCompabymemo(TBasisDictCompabymemoId id, String businname,
	...
	public TBasisDictCompabymemoId getId() {
		return this.id;
	}

	public void setId(TBasisDictCompabymemoId id) {
		this.id = id;
	}
