...
/**
 * TBasisBusPlanstoreId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class TBasisBusPlanstoreId implements java.io.Serializable {
	...
	/** default constructor */
	public TBasisBusPlanstoreId() {
	}

	/** full constructor */
	public TBasisBusPlanstoreId(String businid, String businidbranch) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TBasisBusPlanstoreId))
			return false;
		TBasisBusPlanstoreId castOther = (TBasisBusPlanstoreId) other;
